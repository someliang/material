...
from .models import Material, ClassRoom, UserProfile
class UserProfileAdmin(admin.ModelAdmin):
    ...
    def get_email(self, obj):# 定义这个函数是由于email是在userprofile表的外键表user里，所以需要单独return一下return obj.user.email
    ...
    get_is_active.short_description = u'有效'
